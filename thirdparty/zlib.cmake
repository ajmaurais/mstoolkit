...
if(NOT ZLIB_FOUND)
	...
	ExternalProject_Add(zlib_external
			...
			LOG_DOWNLOAD 0
			LOG_BUILD 0
			CONFIGURE_COMMAND ${ZLIB_SRC_BASE}/src/zlib_external/configure --prefix=${CMAKE_CURRENT_BINARY_DIR} --includedir ${CMAKE_CURRENT_BINARY_DIR}/include --libdir ${CMAKE_CURRENT_BINARY_DIR}/lib 
